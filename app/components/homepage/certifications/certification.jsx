...
function Certification({ id, certification }) {
  return (
    <div
      className="w-full max-w-[340px] h-fit flex flex-col items-center justify-center transition-all duration-500 m-3 sm:m-5 rounded-lg group relative hover:scale-[1.15] cursor-pointer lg:flex-1 lg:max-w-none"
      key={id}
    >
